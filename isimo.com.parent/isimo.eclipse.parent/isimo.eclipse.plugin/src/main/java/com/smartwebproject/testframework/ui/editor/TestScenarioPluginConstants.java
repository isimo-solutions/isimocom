...
public class TestScenarioPluginConstants {
	...
	public final static String SUSPEND_ON_ERROR =TestCases.SUSPEND_ON_ERROR_PROPERTY;
	public final static String SUSPEND_ON_FAILURE =TestCases.SUSPEND_ON_FAILURE_PROPERTY;
